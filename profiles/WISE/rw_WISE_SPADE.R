...
summary(HORIZON$BLD)
SPROPS.WISE <- join(HORIZON[,c("SOURCEID","SAMPLEID","UHDICM","LHDICM","DEPTH","CRFVOL","CECSUM","SNDPPT","CLYPPT","BLD","SLTPPT","PHIHOX","PHIKCL","ORCDRC")], SITE.s[,c("SOURCEID","LONWGS84","LATWGS84","SOURCEDB","TIMESTRR")])
str(SPROPS.WISE)
