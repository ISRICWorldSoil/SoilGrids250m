...
zipfile <- "/data/mask/LMK_tiled_250m.zip"
...
x <- sapply(1:nrow(zp.lst), function(x){unzip(zipfile, files=zp.lst$Name[x], overwrite=TRUE, exdir=paste0("/data/covs/", dir.lst[x]))})
