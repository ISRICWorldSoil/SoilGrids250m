...
hist(soilwell2[soilwell2$SOURCEDB!= "Wells",]$BDRICM, main = "", xlab = "Censored depth to bedrock from soils(cm)" )
hist(soilwell2[soilwell2$SOURCEDB == "Wells",]$BDRICM, main = "", xlab = "Censored depth to bedrock from wells(cm)", breaks= 100 )
dev.off()
par(mar = c(5.1,4.1,4.1,2.1), mfcol=c(1,1))
